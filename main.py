...
with st.sidebar:
    ...
    if input_method == "上传文件":
        ...
        # URL输入
        st.session_state.input_url = st.text_input("输入URL:", key='input_url')
...
# 主界面
st.markdown("<div class='main-title'>贵中医数据分析智能体</div>", unsafe_allow_html=True)
...
if input_method == "上传文件" and st.session_state.uploaded_file:
    with st.container():
        ...
        if file_type == "Excel":
            ...
            st.dataframe(st.session_state.df.head(10).style.background_gradient(cmap='Blues'))
...
<div style="text-align: center; color: #6c757d; padding: 20px;">
    <p>贵州中医药大学 · 人工智能研究中心 © 2023</p>
    <p>技术支持: AI实验室 | 版本: 1.2.0</p>
</div>
""", unsafe_allow_html=True)